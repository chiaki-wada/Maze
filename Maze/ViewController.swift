...
//  Maze
//
//  Created by Chiaki Wada on 2023/05/09.
//
...
class ViewController: UIViewController {
    ...
    //迷路の1マスとなるUIVIewを作る
    //マスのステータス（maze配列のどの要素のマスか・マスの大きさ）などから位置や大きさを設定
